...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'normal-opaque': 'rgba(168, 167, 122, 0.1)',
        fire: 'rgba(238, 129, 48, 1)',
        'fire-opaque': 'rgba(238, 129, 48, 0.1)',
        water: 'rgba(99, 144, 240, 1)',
        'water-opaque': 'rgba(99, 144, 240, 0.1)',
        electric: 'rgba(247, 208, 44, 1)',
        'electric-opaque': 'rgba(247, 208, 44, 0.1)',
        grass: 'rgba(122, 199, 76, 1)',
        'grass-opaque': 'rgba(122, 199, 76, 0.1)',
        ice: 'rgba(150, 217, 214, 1)',
        'ice-opaque': 'rgba(150, 217, 214, 0.1)',
        fighting: 'rgba(194, 46, 40, 1)',
        'fighting-opaque': 'rgba(194, 46, 40, 0.1)',
        poison: 'rgba(163, 62, 161, 1)',
        'poison-opaque': 'rgba(163, 62, 161, 0.1)',
        ground: 'rgba(226, 191, 101, 1)',
        'ground-opaque': 'rgba(226, 191, 101, 0.1)',
        flying: 'rgba(169, 143, 243, 1)',
        'flying-opaque': 'rgba(169, 143, 243, 0.1)',
        psychic: 'rgba(249, 85, 135, 1)',
        'psychic-opaque': 'rgba(249, 85, 135, 0.1)',
        bug: 'rgba(166, 185, 26, 1)',
        'bug-opaque': 'rgba(166, 185, 26, 0.1)',
        rock: 'rgba(182, 161, 54, 1)',
        'rock-opaque': 'rgba(182, 161, 54, 0.1)',
        ghost: 'rgba(115, 87, 151, 1)',
        'ghost-opaque': 'rgba(115, 87, 151, 0.1)',
        dragon: 'rgba(111, 53, 252, 1)',
        'dragon-opaque': 'rgba(111, 53, 252, 0.1)',
        dark: 'rgba(112, 87, 70, 1)',
        'dark-opaque': 'rgba(112, 87, 70, 0.1)',
        steel: 'rgba(183, 183, 206, 1)',
        'steel-opaque': 'rgba(183, 183, 206, 0.1)',
        fairy: 'rgba(214, 133, 173, 1)',
        'fairy-opaque': 'rgba(214, 133, 173, 0.1)',
      },
      animation: {
  ...
  safelist: [
    ...
    {
      pattern:
        /to-(normal|fire|water|electric|grass|ice|fighting|poison|ground|flying|psychic|bug|rock|ghost|dragon|dark|steel|fairy)/,
    },
  ],
  plugins: [],
};
